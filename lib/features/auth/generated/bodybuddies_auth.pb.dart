...
class UserDto extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, UserDto_PasswordOptional> _UserDto_PasswordOptionalByTag = {
    3 : UserDto_PasswordOptional.password,
    0 : UserDto_PasswordOptional.notSet
  };
  ...
  UserDto_PasswordOptional whichPasswordOptional() => _UserDto_PasswordOptionalByTag[$_whichOneof(0)]!;
  void clearPasswordOptional() => clearField($_whichOneof(0));
