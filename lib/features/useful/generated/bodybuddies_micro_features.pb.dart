...
class AllAdvicesDto extends $pb.GeneratedMessage {
  factory AllAdvicesDto({
    $core.Iterable<AdviceDto>? advices,
  }) {
    final $result = create();
    if (advices != null) {
  ...
  AllAdvicesDto._() : super();
  factory AllAdvicesDto.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AllAdvicesDto.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllAdvicesDto', createEmptyInstance: create)
    ..pc<AdviceDto>(1, _omitFieldNames ? '' : 'advices', $pb.PbFieldType.PM, subBuilder: AdviceDto.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AllAdvicesDto clone() => AllAdvicesDto()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AllAdvicesDto copyWith(void Function(AllAdvicesDto) updates) => super.copyWith((message) => updates(message as AllAdvicesDto)) as AllAdvicesDto;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AllAdvicesDto create() => AllAdvicesDto._();
  AllAdvicesDto createEmptyInstance() => create();
  static $pb.PbList<AllAdvicesDto> createRepeated() => $pb.PbList<AllAdvicesDto>();
  @$core.pragma('dart2js:noInline')
  static AllAdvicesDto getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AllAdvicesDto>(create);
  static AllAdvicesDto? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<AdviceDto> get advices => $_getList(0);
}

class AdviceDto extends $pb.GeneratedMessage {
  factory AdviceDto({
    $core.String? id,
    $core.String? title,
    $core.String? body,
  ...
  AdviceDto._() : super();
  factory AdviceDto.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AdviceDto.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AdviceDto', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'title')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AdviceDto clone() => AdviceDto()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdviceDto copyWith(void Function(AdviceDto) updates) => super.copyWith((message) => updates(message as AdviceDto)) as AdviceDto;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdviceDto create() => AdviceDto._();
  AdviceDto createEmptyInstance() => create();
  static $pb.PbList<AdviceDto> createRepeated() => $pb.PbList<AdviceDto>();
  @$core.pragma('dart2js:noInline')
  static AdviceDto getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AdviceDto>(create);
  static AdviceDto? _defaultInstance;
...
class WorkoutDto extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WorkoutDto', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'title')
    ..pc<ExerciseDto>(4, _omitFieldNames ? '' : 'exercises', $pb.PbFieldType.PM, subBuilder: ExerciseDto.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<ExerciseDto> get exercises => $_getList(2);
}
...
class ExerciseDto extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExerciseDto', createEmptyInstance: create)
    ...
    ..aOB(4, _omitFieldNames ? '' : 'isExercise', protoName: 'isExercise')
    ..aOB(5, _omitFieldNames ? '' : 'isTimerExercise', protoName: 'isTimerExercise')
    ..aOS(6, _omitFieldNames ? '' : 'weight')
    ..aOS(7, _omitFieldNames ? '' : 'reps')
    ..aOS(8, _omitFieldNames ? '' : 'sets')
    ..aOS(9, _omitFieldNames ? '' : 'exerciseTimeMinutes', protoName: 'exerciseTimeMinutes')
    ..aOS(10, _omitFieldNames ? '' : 'exerciseTimeSeconds', protoName: 'exerciseTimeSeconds')
    ..aOS(11, _omitFieldNames ? '' : 'restTimeMinutes', protoName: 'restTimeMinutes')
    ..aOS(12, _omitFieldNames ? '' : 'restTimeSeconds', protoName: 'restTimeSeconds')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set workoutId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasWorkoutId() => $_has(1);
  @$pb.TagNumber(2)
  void clearWorkoutId() => clearField(2);
  ...
  @$pb.TagNumber(4)
  $core.bool get isExercise => $_getBF(3);
  @$pb.TagNumber(4)
  set isExercise($core.bool v) { $_setBool(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasIsExercise() => $_has(3);
  @$pb.TagNumber(4)
  void clearIsExercise() => clearField(4);

  @$pb.TagNumber(5)
  $core.bool get isTimerExercise => $_getBF(4);
  @$pb.TagNumber(5)
  set isTimerExercise($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasIsTimerExercise() => $_has(4);
  @$pb.TagNumber(5)
  void clearIsTimerExercise() => clearField(5);

  @$pb.TagNumber(6)
  $core.String get weight => $_getSZ(5);
  @$pb.TagNumber(6)
  set weight($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $core.String get reps => $_getSZ(6);
  @$pb.TagNumber(7)
  set reps($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasReps() => $_has(6);
  @$pb.TagNumber(7)
  void clearReps() => clearField(7);

  @$pb.TagNumber(8)
  $core.String get sets => $_getSZ(7);
  @$pb.TagNumber(8)
  set sets($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasSets() => $_has(7);
  @$pb.TagNumber(8)
  void clearSets() => clearField(8);

  @$pb.TagNumber(9)
  $core.String get exerciseTimeMinutes => $_getSZ(8);
  @$pb.TagNumber(9)
  set exerciseTimeMinutes($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasExerciseTimeMinutes() => $_has(8);
  @$pb.TagNumber(9)
  void clearExerciseTimeMinutes() => clearField(9);

  @$pb.TagNumber(10)
  $core.String get exerciseTimeSeconds => $_getSZ(9);
  @$pb.TagNumber(10)
  set exerciseTimeSeconds($core.String v) { $_setString(9, v); }
  @$pb.TagNumber(10)
  $core.bool hasExerciseTimeSeconds() => $_has(9);
  @$pb.TagNumber(10)
  void clearExerciseTimeSeconds() => clearField(10);

  @$pb.TagNumber(11)
  $core.String get restTimeMinutes => $_getSZ(10);
  @$pb.TagNumber(11)
  set restTimeMinutes($core.String v) { $_setString(10, v); }
  @$pb.TagNumber(11)
  $core.bool hasRestTimeMinutes() => $_has(10);
  @$pb.TagNumber(11)
  void clearRestTimeMinutes() => clearField(11);

  @$pb.TagNumber(12)
  $core.String get restTimeSeconds => $_getSZ(11);
  @$pb.TagNumber(12)
  set restTimeSeconds($core.String v) { $_setString(11, v); }
  @$pb.TagNumber(12)
  $core.bool hasRestTimeSeconds() => $_has(11);
  @$pb.TagNumber(12)
  void clearRestTimeSeconds() => clearField(12);
}
