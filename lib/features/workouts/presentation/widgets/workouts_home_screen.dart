                    ...
                    child: Row(
                      ...
                      children: [
                       const Column(
                         crossAxisAlignment: CrossAxisAlignment.start,
                         children: [
                         Text("Название программы", style: Styles.medium_dark_boxes_text,),
                         Text("Понедельник", style: Styles.small_dark_boxes_text,),
                         SizedBox(height: Styles.big_height_of_text_to_widget,),
                         Text("Грудь, бицепс", style: Styles.medium_dark_boxes_text,)
                       ],),
                        SizedBox(width: 8,),
                        Column(children: [
                          SizedBox(height: 8,),
                          Icon(BottomIcons.dumbbell, size: 40, color: Colours.white_text_color,),
                          SizedBox(height: 18),
                          BaseButton(onClick: () {}, buttonText: "Начать", icon: null, isElevated: true)
                        ],),
                      ],
                    ),
                  ),
